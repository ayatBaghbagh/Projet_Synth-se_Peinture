  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col items-stretch p-4 w-screen">
      ...
      {isLoading ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8 px-2 sm:px-4 mt-6">
          {filteredProjets.map(projet => (
            ...
            >
              ...
              <div className="p-5">
                <h3 className="font-bold text-lg mb-1 text-gray-800 truncate">{projet.titre}</h3>
                <p className="text-sm text-gray-600 mb-3">
                  {projet.date_d} {projet.date_f ? ` - ${projet.date_f}` : ''}
                </p>
